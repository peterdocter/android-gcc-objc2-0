...
Class object_setClass(id obj, Class cls)
{
    if (obj) {
        ...
        do {
            old = obj->isa;
        } while (! __sync_bool_compare_and_swap((id*)&obj->isa, old, cls));
        return old;
    }
    else return Nil;
}
...
//TODO: Build ASM calls to _objc_msgForward and _objc_msgForward_stret

id _objc_msgForward(id self, SEL sel, ...);

id _objc_msgForward_stret(id self, SEL sel, ...);
...
id _objc_ignored_method(id self, SEL _cmd) { return self; }
